...
Dùng:
  python scripts/sync_dataset.py                          # mọi session trong data/raw
  python scripts/sync_dataset.py data/raw/session_XXXX
  python scripts/sync_dataset.py --dcam-ms 100 --tol-ms 60 --no-imu --keep-all-modes
  # (tương đương: python -m jepa_wm.data.sync ...)
"""
import argparse
import bisect
import csv
